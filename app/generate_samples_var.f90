program gwlisa__generate_samples_var
  ...
  do k = 1, ncurves
    ...
    do i = 1, nd%num - 1
      ...
      Vb_bin(ibin) = Vb_bin(ibin) + nd%variance(i)
  ...
  call f%open( &
    "data/ewpt_general/samples_Tfree_var.csv", &
  ...
  write(*,*) "Random signal dataset written to samples_Tfree_var.csv"
block
  type(csv_file) :: ff
  logical :: ok2
...
end program gwlisa__generate_samples_var
